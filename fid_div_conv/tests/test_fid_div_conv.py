...
def test_first_run_bootstraps_runtime_home_and_generates_outputs(tmp_path):
    ...
    qif_path = tmp_path / "dividends_by_fund_20260107_20260110.qif"
    ...
    assert "Generated QIF: dividends_by_fund_20260107_20260110.qif" in result.stdout
...
def test_runtime_config_is_seeded_once_from_legacy_adjacent_file_and_then_persists(tmp_path):
    ...
    assert json.loads(runtime_config_path.read_text(encoding="utf-8")) == legacy_config
