...
class TestPlanningPhaseStreaming:
    ...
    def test_file_planned_events_appear_in_api_event_feed_after_passthrough_planning(
        ...
        _poll_session_status(page, "planning-e2e-001", {"running", "idle", "aborted", "planning", "resolving"})
        # Wait for it to finish
        _poll_session_status(page, "planning-e2e-001", {"idle", "aborted"})
    ...
    def test_phase_activity_card_renders_and_no_js_errors_during_planning_phase(
        ...
        _poll_session_status(page, "planning-render-001", {"idle", "aborted"})
        ...
        assert result["session"]["status"] in {"idle", "aborted"}
...
class TestElapsedTimers:
    ...
    def test_elapsed_timer_updates_during_session_execution(
        ...
        _poll_session_status(page, "elapsed-ui-001", {"running", "planning", "resolving", "idle"})
