...
def build_dashboard_payload(
    ...
    *,
    ...
    return {
        ...
        "runtime_state": {
            "completed_since_verification": rs.completed_since_verification,
            "verification_pending": rs.verification_pending,
            "verification_reason": rs.verification_reason,
            "verification_started_at": rs.verification_started_at,
            "verification_elapsed": (
                int(_elapsed_seconds(rs.verification_started_at))
                if rs.verification_started_at
                else None
            ),
            "auto_fix_context": rs.auto_fix_context,
            "auto_fix_task_id": rs.auto_fix_task_id,
            "auto_fix_attempt": rs.auto_fix_attempt,
            "last_fix_summary": rs.last_fix_summary,
        },
        "effective_runtime_config": effective_runtime_config.to_dict(),
        **(
            {
